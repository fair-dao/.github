...
Ten en cuenta que al participar en este proyecto, se espera que respetes nuestro [Código de Conducta](CODE_OF_CONDUCT.md).
...
Nota: Si divide su solicitud de extracción en cambios pequeños, asegúrese de que cualquier cambio que se envíe a la rama maestra (main) no rompa nada. De lo contrario, estos cambios no se pueden fusionar hasta que se complete esta función.
