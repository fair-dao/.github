...
**Доступно на других языках:** [English](CONTRIBUTING.md) - Английский, [中文](CONTRIBUTING_CN.md) - Китайский, [Español](CONTRIBUTING_ES.md) - Испанский, [Français](CONTRIBUTING_FR.md) - Французский, [العربية](CONTRIBUTING_AR.md) - Арабский, [हिन्दी](CONTRIBUTING_HI.md) - Хинди, [日本語](CONTRIBUTING_JA.md) - Японский
...
Обратите внимание, что при участии в этом проекте вы должны соблюдать наше [Положение о поведении](CODE_OF_CONDUCT.md).
...
Примечание: Если вы разделяете свой запрос на включение изменений на небольшие изменения, убедитесь, что любые изменения, отправленные в главную ветку (main), не нарушат никаких функций. В противном случае, эти изменения не могут быть объединены, пока функция не будет завершена.
...
## Награды за вклад
Мы поощряем всех участвовать в вкладах и можете оставить свой адрес кошелька TRON (по крайней мере один раз). Мы будем оценивать ваш уровень вклада в каждый цикл (месяц или квартал) и распределять токены FAIR в качестве награды активным участникам.